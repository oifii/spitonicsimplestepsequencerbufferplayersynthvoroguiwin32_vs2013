...
#include "stdafx.h"
#include "spitonicsimplestepsequencerbufferplayersynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicsimplestepsequencerbufferplayersynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicsimplestepsequencerbufferplayersynthvoroguiwin32class"};				// the main window class name
